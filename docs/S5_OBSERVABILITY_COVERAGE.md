...
- API17 regression evidence should include at least one QR auth event, one auth dialog/recovery event, and one Kugou content/queue/radio event when the corresponding flow is tested.
